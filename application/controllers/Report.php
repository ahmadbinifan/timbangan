...
class report extends CI_Controller
{
    ...
    public function printByPriode($start = null, $end = null, $no_ref = null)
    {
        $this->load->library('Pdf');
    ...
    public function printByPriodeDsip($start = null, $end = null, $no_ref = null)
    {
        $this->load->library('Pdf');
        // $data['more'] = $this->weighbridge->getMore($start, $end);
        $data['title'] = "WEIGHBRIDGE REPORT";
    ...
    public function phpExcel_wb($id = null)
    {
        ...
        foreach ($data['more'] as $value) {
            ...
            $spreadsheet->setActiveSheetIndex(0)->setCellValue('L' . $i, $totalSupp);
            $spreadsheet->setActiveSheetIndex(0)->setCellValue('O' . $i, $totalKage);
            $spreadsheet->setActiveSheetIndex(0)->setCellValue('P' . $i, number_format($totalPercent, 2) . "%");
        }
    ...
    public function phpExcel_wb_dsip($id = null)
    {
    ...
    public function phpExcel_wb_priode($start = null, $end = null, $no_ref = null)
    {
        $data['title'] = "Weighbridge Report - PT. Domas Agrointi Prima (DAP)";
    ...
    public function phpExcel_wb_dsip_priode($start = null, $end = null, $no_ref = null)
    {
        $data['title'] = "Weighbridge Report - PT. Domas Sawit Inti Perdana (DSIP)";
        $data['subtitle'] = "From Date : " . date('d-F-Y', strtotime($start)) . ' to Date : ' .  date('d-F-Y', strtotime($end));

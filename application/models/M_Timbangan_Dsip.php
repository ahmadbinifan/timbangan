...
class M_Timbangan_Dsip extends CI_Model
{
    ...
    var $column_order = array(null, 'no_seri', 'tgl_msk', 'jam_msk', 'tgl_klr', 'jam_klr', 'no_pol', 'no_con', 'nm_rls', 'no_ref', 'nm_brg', 'brt_1', 'brt_2', 'tmb_gross_rls', 'tmb_tare_rls', 'tmb_netto_rls', 'Split_PO', 'NoPO_Split', 'Qty_PO', 'Package_Type', 'Container_Type'); //set column field database for datatable orderable
    ...
    {
        return $this->db->select('nm_rls , nm_brg')->order_by('nm_brg', 'desc')->where('no_ref', $params)->get($this->table)->row();
    }

...
class weighbridge_out_dsip extends CI_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model(['M_Timbangan_Out_Dsip' => 'weighbridge']);
    }
    ...
    public function index()
    {
        adminAccess();
        $data = [
            'title' => 'PT. DSIP - Weighbridge Out',
            'no_ref' => $this->weighbridge->get_noRef(),
            'nm_brg' => $this->weighbridge->get_barang(),
        ];

        backView('weighbridge_out_dsip/index', $data);
    }
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $value) {
            ...
            if ($value->brt_1 == null) {
                $brt_1 = "<div class='badge badge-danger'>Loading</div>";
            } elseif ($value->brt_1) {
                $brt_1 = $value->brt_1;
            }

...
<body>
    ...
    <div class="">
        <p style="font-size: 13px;"><b>PT. DOMAS AGROINTI PRIMA <br>
                PT. DOMAS SAWIT INTI PERDANA <input type="checkbox" style="  line-height: 0.7;" checked> </b>
    ...
    <p>Total <span class="tab" style="margin-left:38px;"></span> : <?= number_format($total) ?> Kg/Ltr <br>
        Balance <span class="tab" style="margin-left:26px ;"></span> : <?= number_format($balanceFooter) ?> Kg/Ltr <br>
